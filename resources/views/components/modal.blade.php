...
<div x-data="{
    ...
    <div x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false"
        ...
        x-transition:enter-end="opacity-60" x-transition:leave="ease-in duration-200"
        x-transition:leave-start="opacity-60" x-transition:leave-end="opacity-0">
        <div class="absolute inset-0 bg-pink-900 opacity-60"></div>
    </div>

    <!-- Modal Content -->
    <div x-show="show"
        class="mb-6 bg-pink-50 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
